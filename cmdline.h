...
#define CMDLINE_PARSER_PACKAGE "mpdtray"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "mpdtray"
#endif
...
struct gengetopt_args_info
{
  ...
  int timeout_arg;	/**< @brief mpd timeout for synchronous operations (default='0').  */
  char * timeout_orig;	/**< @brief mpd timeout for synchronous operations original value given at command line.  */
  const char *timeout_help; /**< @brief mpd timeout for synchronous operations help description.  */
