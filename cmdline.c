...
const char *gengetopt_args_info_purpose = "A simple MPD tray icon using GTK.";

const char *gengetopt_args_info_usage = "Usage: mpdtray [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -p, --port=INT     mpd port  (default=`6600')",
  "  -h, --host=STRING  mpd host  (default=`localhost')",
  "  -t, --timeout=INT  mpd timeout for synchronous operations  (default=`0')",
    0
};
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vp:h:t:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* mpd host.  */
          ...
          break;
        case 't':	/* mpd timeout for synchronous operations.  */
